...
public class PullToRefreshListView extends
		PullToRefreshAbsListViewBase<ListView> {
	...
	public int getHeaderViewsCount() {
		return refreshableView.getHeaderViewsCount();
	}

	public void setDivider(Drawable divider) {
		refreshableView.setDivider(divider);
	}

	public void setDividerHeight(int height) {
		refreshableView.setDividerHeight(height);
	}
	...
	public boolean removeHeaderView(View v) {
		return refreshableView.removeHeaderView(v);
	}
	...
	{
		refreshableView.setSelectionFromTop(position, offset);
	}
	...
	public void addFooterView(View v) {
		refreshableView.addFooterView(v);
	}

	public void addHeaderView(View v, Object data, boolean isSelectable) {
		refreshableView.addHeaderView(v, data, isSelectable);
	}

	public void addFooterView(View v, Object data, boolean isSelectable) {
		refreshableView.addFooterView(v, data, isSelectable);
	}
	
	public void setHeaderDividersEnabled(boolean headerDividersEnabled)
	{
		refreshableView.setHeaderDividersEnabled(headerDividersEnabled);
	}
	
	public void setFooterDividersEnabled(boolean footerDividersEnabled)
	{
		refreshableView.setFooterDividersEnabled(footerDividersEnabled);
	}
	
	public int getDividerHeight(){
		return refreshableView.getDividerHeight();
	}

	public void removeFooterView(View v) {
		refreshableView.removeFooterView(v);
	}

	public int getFooterViewsCount() {
		return refreshableView.getFooterViewsCount();
	}
